	...
	<section id="main" class="clearfix myads-page">
		<div class="container">
			...
			<div class="breadcrumb-section">
				...
				<h2 class="title">Todos Mis Anuncios</h2>
			</div><!-- banner -->
			...
			<div class="ad-profile section">
					...
					<ul class="user-menu">
						<li class="active"><a href="{{ URL::action('HomeController@home_seller') }}">Todos Mis Anuncios</a></li>
							...
							<div class="ad-item row">
								...
								<div class="item-info col-sm-8">
									...
									@endif	
										...
										@if($product->status == 3)
											<span>Quedan: {{$product->time_to_expired}} Dias</span>
										@endif
									</div><!-- ad-info -->
									...
									@elseif($product->status == 4)
										<div class="meta-content">
											<span class="dated">Uploaded On: <a href="#">{{$fecha}} </a></span>
											<span class="pending">Expirado</span>
										</div>
									@endif	
