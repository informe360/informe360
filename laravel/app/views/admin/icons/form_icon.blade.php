			...
			<div class="row text-center">
				...
				<div class="col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
					<div class="user-account">
						...
						{{ Form::open(array('url' => 'admin/icono/nuevo', 'method' => 'post', 'enctype' => 'multipart/form-data')) }}
							<div class="form-group">
								<input type="text" name="iconname" class="form-control" placeholder="Nombre de la categoria a asociar" >
