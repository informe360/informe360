						...
						<div class="my-ads section">
							...
							<div class="ad-item row">
								...
								<div class="item-info col-sm-8">
									<!-- ad-info -->
									<div class="ad-info">
										<h3 class="item-price">Bark Furniture, Handmade Bespoke Furniture</h3>
									...
									<div class="ad-meta">
										...
										<div class="user-option pull-right">
											...
											<a class="delete-item" href="#" data-toggle="tooltip" data-placement="top" title="Negar Publicacion"><i class="fa fa-times"></i></a>
											<a class="check-item" href="#" data-toggle="tooltip" data-placement="top" title="Aprobar Publicacion"><i class="fa fa-check"></i></a>
										</div>
									</div><!-- ad-meta -->
								</div><!-- item-info -->
							</div><!-- ad-item -->
